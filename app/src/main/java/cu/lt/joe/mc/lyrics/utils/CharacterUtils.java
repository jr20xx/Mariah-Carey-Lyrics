...
{
    @NonNull
    public static List<CharacterDiffResult> diff(@NonNull CharSequence oldText, @NonNull CharSequence newText)
    {
    ...
    public static int needMove(int index, @NonNull List<CharacterDiffResult> differentList)
    {
    ...
    public static boolean stayHere(int index, @NonNull List<CharacterDiffResult> differentList)
    {
        for (CharacterDiffResult different : differentList)
    ...
    {
        public char c;
        public int fromIndex, moveIndex;
    }
}